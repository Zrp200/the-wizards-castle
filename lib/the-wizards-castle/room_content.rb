module TheWizardsCastle
  class RoomContent
    ...
    def initialize(intcode, curses = Hash.new false)
      raise "Unrecognized intcode" unless RoomContent.valid_intcode?(intcode)
      @intcode = intcode
      @cursed_with_lethargy = curses[:lethargy]
      @cursed_with_leech = curses[:leech]
      @cursed_with_forgetfulness = curses[:forget]
    end
